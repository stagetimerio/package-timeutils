...
describe('applyDate', () => {
  ...
  test('US DST change March 12 (America/Los_Angeles)', () => {
    ...
    const output = applyDate(inTime, inDate, tz)
    expect(output).to.deep.equal(new Date('2023-03-13T15:10:00.000Z')) // Mon Mar 13 2023 08:10:00 GMT-0700 (Pacific Daylight Time)
  })
  ...
  test('DE DST change March 26 (Europe/Berlin)', () => {
    ...
    const output = applyDate(inTime, inDate, tz)
    expect(output).to.deep.equal(new Date('2023-03-28T15:10:00.000Z')) // Tue Mar 28 2023 17:10:00 GMT+0200 (Central European Summer Time)
  })
  ...
  test('AU DST change Oct 1 (Australia/Sydney)', () => {
    ...
    const output = applyDate(inTime, inDate, tz)
    expect(output).to.deep.equal(new Date('2023-10-01T15:10:00.000Z')) // Mon Oct 02 2023 02:10:00 GMT+1100 (Australian Eastern Daylight Time)
  })
})
