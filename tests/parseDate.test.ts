...
describe('parseDate', () => {
  ...
  test('Parse full ISO strings (w/o timezone)', () => {
    expect(parseDate('2020-03-03T00:00:00.000Z')).to.deep.equal(
      new Date('2020-03-03T00:00:00.000Z')
    )
    expect(parseDate('2020-03-03T00:00:00.000+00:00')).to.deep.equal(
      new Date('2020-03-03T00:00:00.000Z')
    )
  })
  ...
  test('Parse full ISO strings (UTC)', () => {
    const tz = 'UTC'
    expect(parseDate('2020-03-03T00:00:00.000Z', tz)).to.deep.equal(
      new Date('2020-03-03T00:00:00.000Z')
    )
    expect(parseDate('2020-03-03T00:00:00.000+00:00', tz)).to.deep.equal(
      new Date('2020-03-03T00:00:00.000Z')
    )
  })
  ...
  test('Parse yyyy-mm-dd (w/o timezone)', () => {
    ...
    expect(parseDate('2020-03-03')).to.deep.equal(
      addMinutes(new Date('2020-03-03T00:00:00.000Z'), tzOffset)
    )
  })

  test('Parse yyyy-mm-dd (UTC)', () => {
    const tz = 'UTC'
    expect(parseDate('2020-03-03', tz)).to.deep.equal(
      new Date('2020-03-03T00:00:00.000Z')
    )
  })
  ...
  test('Parse yyyy-mm-dd (Europe/Berlin)', () => {
    const tz = 'Europe/Berlin'
    expect(parseDate('2020-03-03', tz)).to.deep.equal(
      new Date('2020-03-03T01:00:00.000Z')
    )
  })
  ...
  test('Parse yyyy-mm-dd (America/Los_Angeles)', () => {
    const tz = 'America/Los_Angeles'
    expect(parseDate('2020-03-03', tz)).to.deep.equal(
      new Date('2020-03-02T16:00:00.000Z')
    )
  })
