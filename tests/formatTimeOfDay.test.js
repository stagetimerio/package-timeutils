...
describe('formatTimeOfDay', () => {
  ...
  it('should format time in 12h_a format in Europe/Berlin timezone', () => {
    const date = new Date('2023-06-17T15:10:30Z')
    const formatted = formatTimeOfDay(date, { format: '12h_a', seconds: 'always', timezone: 'Europe/Berlin' })
  ...
  it('should format time in 12h_a format in Australia/Sydney timezone', () => {
    const date = new Date('2023-06-17T15:10:30Z')
    const formatted = formatTimeOfDay(date, { format: '12h_a', seconds: 'always', timezone: 'Australia/Sydney' })
  ...
  it('should format time in 12h_a format in America/Los_Angeles timezone', () => {
    const date = new Date('2023-06-17T15:10:30Z')
    const formatted = formatTimeOfDay(date, { format: '12h_a', seconds: 'always', timezone: 'America/Los_Angeles' })
  ...
  // Tests for the leading zero option
